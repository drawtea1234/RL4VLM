...
from transformers import AutoTokenizer, AutoProcessor, AutoImageProcessor, Qwen2VLForConditionalGeneration, Qwen2TokenizerFast, Qwen2ForCausalLM, Qwen2VLImageProcessor
import transformers
...
def main():
    ...
    # tokenizer = Qwen2TokenizerFast.from_pretrained("Qwen/Qwen-tokenizer", cache_dir=cache_dir)
    ...
    # base = Qwen2ForCausalLM.from_pretrained(model_path)
    ...
    # find_all_linear_names(base, args.train_vision)
...
# 直接通过索引修改
    conversation[0]["content"][1]["text"] = qs
    ...
    inputs = processor(text=[text_prompt], images=[obs], padding=True, return_tensors="pt")
    # inputs = inputs.to('cuda')

    # # Inference: Generation of the output
    # output_ids = base.generate(**inputs, max_new_tokens=128)
