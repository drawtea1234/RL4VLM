...
from transformers import AutoTokenizer, AutoModelForCausalLM, AutoConfig, BitsAndBytesConfig,  Qwen2VLForConditionalGeneration
...
def load_lora_model(model_path, model_base = "Qwen/Qwen2-VL-2B-Instruct",load_8bit=False, load_4bit=False, cache_dir=None):
    ...
    model = Qwen2VLForConditionalGeneration.from_pretrained(model_base, low_cpu_mem_usage=True, config=lora_cfg_pretrained, cache_dir=cache_dir, **kwargs)
